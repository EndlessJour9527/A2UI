...
| Local run storage | Studio storage backend, `eval/genui_eval/studio_storage.py` |
| Studio orchestration | Studio orchestrator backend, `eval/genui_eval/studio_orchestrator.py` |
